...
public class ExpenseDbHelper extends SQLiteOpenHelper {
    ...
    public long insertManual(String type, String status, double amount, String title, int affectsBudget, String raw) {
        ...
        tx.type = type; tx.status = status; tx.amount = amount; tx.currency = getCurrency();
    ...
    public static class Tx {
        public long id; public String type; public String status; public double amount; public String title; public String merchant;
